...
import { Ship, TriangleAlert, Lightbulb, ChartBar as BarChart, ArrowRight } from 'lucide-react';
      ...
      >
        <div className="text-center mb-16">
          ...
          >
            ...
            <Link to="/login" className="btn-secondary flex items-center space-x-2 text-lg">
              <span>Sign In</span>
            </Link>
          </motion.div>
        </div>
